...
export function AssessmentCard({ assessment, onClick }: AssessmentCardProps) {
  ...
  const handleCardClick = (e: React.MouseEvent) => {
    ...
    console.log('Assessment card clicked:', assessment.id);
    
    if (onClick) {
      onClick();
    } else {
      console.log('Navigating to:', `/assessments/${assessment.id}`);
  ...
  return (
    <div 
      className="cursor-pointer hover:shadow-md transition-all duration-200 hover:border-primary-300 rounded-lg border border-gray-200 bg-white shadow-sm p-6" 
